...
tf.app.flags.DEFINE_string('dataset_dir', '/path/to/tf_records/', 'The tfrecords directory.')
tf.app.flags.DEFINE_string('checkpoint_dir',
'/path/to/train_dir',
'The directory to get checkpoint from.')
tf.app.flags.DEFINE_string('log_dir',
'/path/to/save/logs/',
'The log directory.')
tf.app.flags.DEFINE_integer('num_examples', 112500, 'The number of examples in the test set')
tf.app.flags.DEFINE_integer('hidden_units', 256, 'The number of examples in the test set')
tf.app.flags.DEFINE_integer('seq_length', 7500, 'The number of examples in the test set') #150
tf.app.flags.DEFINE_integer('eval_interval_secs', 100, 'The number of examples in the test set')
...
def evaluate(data_folder):
  ...
  with g.as_default():
    ...
    # Load dataset.
    audio_frames, ground_truth,_ = data_provider.get_split(data_folder, False,
